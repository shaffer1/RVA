...
#ifndef __UI_ConnectedThresholdWithCustomSourceGUIPanel_H
#define __UI_ConnectedThresholdWithCustomSourceGUIPanel_H
...
#endif // __UI_ConnectedThresholdWithCustomSourceGUIPanel_H
