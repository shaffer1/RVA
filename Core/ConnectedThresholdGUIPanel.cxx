...
#include "ConnectedThresholdGUIPanel.h"
...
#include "ui_pqConnectedThresholdPanel.h"

class ConnectedThresholdGUIPanel::pqUI : public Ui::ThresholdPanel { };

ConnectedThresholdGUIPanel::ConnectedThresholdGUIPanel(pqProxy* pxy, QWidget* p) :
...
ConnectedThresholdGUIPanel::~ConnectedThresholdGUIPanel()
{
  delete this->UI;
}

void ConnectedThresholdGUIPanel::lowerChanged(double val)
{
...
void ConnectedThresholdGUIPanel::upperChanged(double val)
{
  pqDoubleRangeWidget* snd = dynamic_cast<pqDoubleRangeWidget*>(QObject::sender());
...
void ConnectedThresholdGUIPanel::variableChanged()
{
