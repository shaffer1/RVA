...
The Proximity Threshold filter finds the subset of an object that is a certain 
distance from another object. This filter creates a data array containing the 
distance between each point of the source and the outline of the input dataset. 
=========================================================================*/
