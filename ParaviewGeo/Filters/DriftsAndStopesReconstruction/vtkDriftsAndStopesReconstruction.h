...
Description:
			Sometimes drifts are imported from other softwares as a wireframe.
			It is often useful to restore the original surface representation
			of these drifts, which is the purpose of this filter.
===========================================================================*/
